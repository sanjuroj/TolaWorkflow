...
function (_React$Component3) {
  ...
  function LevelCardExpanded(props) {
    ...
    _this2.saveLevel = function (event) {
...
function (_React$Component4) {
  ...
  _createClass(ButtonBar, [{
    key: "render",
    value: function render() {
      var disabledText = this.props.isActive ? "" : "disabled"; // Build the button text with the right sibling level name, then build the button.
...
var _class, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _temp, _class3, _descriptor9, _descriptor10, _descriptor11, _temp2;
...
function () {
  function LevelStore(program_id, levels, indicators, levelTiers, tierPresets, rootStore) {
    ...
    _initializerDefineProperty(this, "chosenTierSet", _descriptor3, this);

    _initializerDefineProperty(this, "chosenTierSetName", _descriptor4, this);
...
}), _descriptor3 = _applyDecoratedDescriptor(_class.prototype, "chosenTierSet", [mobx__WEBPACK_IMPORTED_MODULE_0__["observable"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor4 = _applyDecoratedDescriptor(_class.prototype, "chosenTierSetName", [mobx__WEBPACK_IMPORTED_MODULE_0__["observable"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
function () {
  function UIStore(rootStore) {
    ...
    _initializerDefineProperty(this, "addExpandedCard", _descriptor10, this);

    _initializerDefineProperty(this, "removeExpandedCard", _descriptor11, this);
...
}), _applyDecoratedDescriptor(_class3.prototype, "tierLockStatus", [mobx__WEBPACK_IMPORTED_MODULE_0__["computed"]], Object.getOwnPropertyDescriptor(_class3.prototype, "tierLockStatus"), _class3.prototype), _descriptor10 = _applyDecoratedDescriptor(_class3.prototype, "addExpandedCard", [mobx__WEBPACK_IMPORTED_MODULE_0__["action"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor11 = _applyDecoratedDescriptor(_class3.prototype, "removeExpandedCard", [mobx__WEBPACK_IMPORTED_MODULE_0__["action"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
//# sourceMappingURL=results_framework-8ad80fbb9833378ccbf6.js.map