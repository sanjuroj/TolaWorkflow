        ...
        return new Promise(function (resolve, reject) {
          _this3.api.validateGaitId(program_data.gaitid, id).then(function (response) {
            if (response.data.unique === false) {
              ...
              var message_text = "".concat(message_intro, " <a href=\"").concat(response.data.gait_link, "\" target=\"_blank\">").concat(link_text, "</a>");
...
//# sourceMappingURL=tola_management_program-14f7123a993d49f4eedf.js.map