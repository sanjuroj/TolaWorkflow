...
describe('IndicatorList', () => {
    it('renders without crashing', () => {
        // Shallow render to avoid calling into bs-multiselect code which breaks tests ATM
        const wrapper = shallow(<IndicatorList rootStore={rootStore} uiStore={uiStore}/>);
    });
});
