    ...
    render() {
        ...
        if (this.props.rootStore.uiStore.tierLockStatus == "locked"){
            ...
            helpIcon = <a href="#"
                ...
                data-trigger="focus"
                data-html="true"
                data-content={gettext('<span class="text-danger"><strong>Choose your results framework template carefully!</strong></span> Once you begin building your framework, it will not be possible to change templates without first deleting all saved levels.')}onClick={e => console.log('here')}>
                <i className="far fa-question-circle"></i></a>
        }
